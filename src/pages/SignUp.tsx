  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <div className="flex-1 flex flex-col items-center px-8">
        ...
        {/* Form */}
        <form onSubmit={handleSignUp} className="w-full max-w-md space-y-3">
          ...
          <Button
            type="submit"
            disabled={loading}
            className={`w-full h-10 bg-gradient-to-r from-meditation-lightBlue to-meditation-mediumBlue hover:bg-meditation-mediumBlue text-white font-medium rounded-xl ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
          >
